...
<body>
    <div class="header">
        <h1 style="text-align:center"><a href="/" class="no-link-color">NE_note (ΦωΦ)</a></h1>
    </div>
                    ...
                    <?php foreach ($this->get('posts') as $post) : ?>
                        ...
                        <div class="post">
                            ...
                            <div class="post-info" data-id="<?=$post['id']?>">
                                ...
                                <textarea class="post-text post-not-edit-textarea" readonly><?=$post["message"]?>にゃーん</textarea>
                                <div class="post-action">
                                    <button type="button" class="post-action-btn good-btn" onclick="goodpost(this)">👍いいね<span class="favorite-count"><?=$post["favorite"]?></span></button>
